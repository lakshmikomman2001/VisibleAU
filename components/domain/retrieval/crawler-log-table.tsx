            ...
            >
              ...
              <td className="px-3 py-2">
                <span
                  ...
                  style={{
                    backgroundColor: `color-mix(in srgb, ${TIER_COLORS[log.crawlerTier ?? "data"]} 15%, transparent)`,
                    color: TIER_COLORS[log.crawlerTier ?? "data"],
                  }}
                >
              ...
              <td
                className="px-3 py-2"
                style={{ color: log.statusCode === 200 ? "var(--success)" : "var(--destructive)" }}
              >
                {log.statusCode ?? "—"}
              </td>
