      ...
      <div className="mt-4 grid gap-4 md:grid-cols-2">
        <div>
          ...
          <p className="text-sm" style={{ color: "var(--foreground)" }}>
            {data.companyPageExists
              ? `Active — ${data.companyPageFollowers ?? 0} followers, ${data.companyPosts30d ?? 0} posts/30d`
              : "Not found"}
          </p>
        </div>
        <div>
          ...
          <p className="text-sm" style={{ color: "var(--foreground)" }}>
            {data.founderProfileExists
              ? `Active — ${data.founderFollowers ?? 0} followers, ${data.founderPosts30d ?? 0} posts/30d`
              : "Not linked"}
          </p>
        </div>
      </div>
