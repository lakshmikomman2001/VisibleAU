...
│   #         await inngest.send({ name: 'audit.run',  // corrected from audit/start — see D-05 v8.69
...
│   #     });
│   #
│   #     // Fan out one audit.run event per brand (corrected from audit/start — see D-05 v8.69) (Inngest handles per-brand concurrency):
