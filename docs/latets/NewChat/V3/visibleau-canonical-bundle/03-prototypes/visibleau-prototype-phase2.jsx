...
const IntelCard = ({ layer, label, value, max = 100, delta, desc, loading = false }) => {
  const m = LAYER_META[layer] || LAYER_META.visibility;
      ...
      <div className="flex items-start justify-between mb-3">
        ...
        {delta !== undefined && (
          <span
            ...
            style={{
              background: isPos ? 'var(--success-soft)' : 'var(--danger-soft)',
...
const TierGate = ({ requiredTier, currentTier, feature }) => (
  <div
    ...
    style={{ background: 'rgba(9,9,11,0.75)', backdropSlidersHorizontal: 'blur(2px)' }}
  >
    <div
...
const Phase2Sidebar = ({ current, onNav, tier = 'Agency' }) => {
  ...
  return (
    ...
    >
      ...
      {/* Nav sections */}
      <nav className="flex-1 px-3 pb-3 space-y-4 mt-2">
      ...
      >
        ...
        <button className="p-1 rounded" style={{ color: 'var(--text-tertiary)' }}>
...
const BrandIntelTabs = ({ active, onTab, tier = 'Agency' }) => {
  const tabs = [
    ...
    { id: 'retrieval',   label: 'Retrieval',  icon: Cpu,              layer: 'retrieval',   minTier: 'Growth'  },
    ...
    { id: 'reports',     label: 'Reports',    icon: FileText,         layer: 'comm',        minTier: 'Starter' },
  ];
        ...
        <div className="grid grid-cols-2 gap-4 mb-6">
          ...
          >
            <div className="gradient-border-card-inner p-5">
              ...
              {/* Task progress pills: 3 inline chips showing task types */}
...
const HealthCheck = ({ onNav }) => {
  const dims = [
    { name: 'Frequency',  score: 20, max: 100, status: 'poor',     icon: Activity  },
    { name: 'Position',   score: 30, max: 100, status: 'moderate', icon: Target    },
    { name: 'Sentiment',  score: 60, max: 100, status: 'good',     icon: ThumbsUp  },
    { name: 'Context',    score: 25, max: 100, status: 'poor',     icon: Cpu     },
    { name: 'Accuracy',   score: 35, max: 100, status: 'moderate', icon: CheckCircle2 },
  ];
    ...
    <div className="flex-1 overflow-y-auto" style={{ background: 'var(--bg-base)' }}>
      <div style={{ maxWidth: 1200, margin: '0 auto', padding: '32px' }}>
            ...
            <div className="grid grid-cols-2 gap-1.5 mb-4">
              {[
                ...
                <div
                  ...
                  style={{
                    background: q.active ? `${q.color}18` : 'var(--bg-hover)',
                    border: q.active ? `1px solid ${q.color}40` : '1px solid transparent',
                  }}
                >
        ...
        <div
          ...
          style={{ background: 'var(--layer-visibility-soft)', border: '1px solid var(--layer-visibility)30' }}
        >
  ...
  return (
    <div className="flex-1 overflow-y-auto" style={{ background: 'var(--bg-base)' }}>
      <div style={{ maxWidth: 1200, margin: '0 auto', padding: '32px' }}>
        ...
        <div className="grid grid-cols-3 gap-4 mb-6">
          {[
            { label: 'Open tasks',       value: 3, sub: '2 high priority',      color: 'var(--layer-workflow)' },
        ...
        {/* TABS */}
        <div className="flex gap-1 mb-5 border-b" style={{ borderColor: 'var(--border-subtle)' }}>
...
const ContentDraftEditor = ({ onNav }) => (
  <div className="flex-1 flex flex-col overflow-hidden" style={{ background: 'var(--bg-base)' }}>
    ...
    >
      <div className="flex items-center gap-3">
        <button onClick={() => onNav('workflow-hub')} style={{ color: 'var(--text-tertiary)' }}>
    ...
    <div className="flex-1 overflow-y-auto" style={{ background: 'var(--bg-base)' }}>
      <div style={{ maxWidth: 1200, margin: '0 auto', padding: '32px' }}>
        ...
        <div className="grid grid-cols-4 gap-4 mb-8">
          ...
          <IntelCard layer="trust" label="Hallucination Risk" value={23} delta={-5}  desc="Lower is better (0=safe)" />
                ...
                return (
                  <div
                    ...
                    style={{
                      ...
                      border: `1px solid ${isWarning ? 'var(--warning)' : 'var(--danger)'}30`,
                    }}
                  >
                ...
                return (
                  <div key={i} className="flex items-center gap-3">
                    ...
                    <div
                      ...
                      style={{ background: p.status === 'absent' ? 'var(--bg-hover)' : `${color}18` }}
                    >
  ...
  return (
    <div className="flex-1 overflow-y-auto" style={{ background: 'var(--bg-base)' }}>
      <div style={{ maxWidth: 1200, margin: '0 auto', padding: '32px' }}>
        ...
        <div className="grid grid-cols-3 gap-4 mb-6">
          {/* llms.txt */}
          <div className="rounded-xl p-5" style={{ background: 'var(--bg-elevated)', border: '1px solid var(--danger)30' }}>
            <div className="flex items-center justify-between mb-3">
              <div className="flex items-center gap-2">
          ...
          {/* Entity Home */}
          <div className="rounded-xl p-5" style={{ background: 'var(--bg-elevated)', border: '1px solid var(--warning)30' }}>
            <div className="flex items-center justify-between mb-3">
              <div className="flex items-center gap-2">
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <div
                  ...
                  style={{ background: 'var(--layer-comm-soft)', border: '1px solid var(--layer-comm)30' }}
                >
              ...
              <div className="flex items-center gap-2">
                <button className="w-7 h-7 rounded-md flex items-center justify-center" style={{ background: 'var(--bg-hover)', color: 'var(--text-secondary)' }}>
              ...
              <div className="flex items-center gap-1">
                {!m.isYou && (
                  <>
                    ...
                    <button className="w-7 h-7 rounded-md flex items-center justify-center" style={{ background: 'var(--danger-soft)', color: 'var(--danger)' }}>
...
//   - Cputom: "Re-audit to measure" CTA
// ============================================================
              ...
              <div key={step.id} className="relative flex gap-5 mb-6 last:mb-0">
                ...
                <div
                  ...
                  style={{
                    ...
                    border: isPending ? `2px dashed ${step.color}60` : `2px solid ${step.color}`,
                ...
                <div className="flex-1 pb-2">
                  <div className="flex items-center gap-2 mb-1">
                    ...
                    {isCurrent && (
                      <span className="text-[10px] px-2 py-0.5 rounded-full font-medium" style={{ background: step.color + '20', color: step.color }}>
                        In progress
                      </span>
                    )}
                  </div>
                  ...
                  {isCurrent && (
                    <div className="mt-3 p-3 rounded-lg" style={{ background: step.color + '12', border: `1px solid ${step.color}30` }}>
    ...
    <>
      ...
      <div className="flex h-screen overflow-hidden" style={{ background: 'var(--bg-base)', color: 'var(--text-primary)', fontFamily: 'var(--font-display)' }}>
        ...
        <div
          ...
          style={{ background: 'rgba(9,9,11,0.95)', border: '1px solid var(--border-strong)', backdropSlidersHorizontal: 'blur(8px)' }}
        >
