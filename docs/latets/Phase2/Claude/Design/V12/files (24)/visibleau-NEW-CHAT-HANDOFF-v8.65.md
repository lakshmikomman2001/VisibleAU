# VisibleAU — NEW CHAT HANDOFF (Phase 2, LLD v8.65)
...
CHECK 1 — LLD version (expect 8.65):
    grep -m1 "^# Version:" visibleau-7layer-lld.md
    → must read: # Version: 8.65 | Date: June 2026

CHECK 2 — Prototype fix-note tip (expect FIX 14):
    grep -c "FIX 14 (v8.65)" visibleau-prototype-phase2.jsx
...
Exact current sizes (for sanity): LLD 9,183 lines / 634,215 bytes;
prototype 3,390 lines / 177,657 bytes. (wc -l convention; bytes are authoritative.)
