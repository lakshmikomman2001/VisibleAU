...
# Version: 1.5 | Built against: LLD v8.68 (REVIEWED) | Sprint: 2 of 9 | 4 weeks
...
CORRECTION`). If the version is below 8.65 (8.65–8.68 all valid) or the marker count is 0, STOP — stale LLD.
