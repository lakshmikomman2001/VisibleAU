...
# Version: 1.1 | Built against: LLD v8.65 (REVIEWED-r2, verified) | Sprint: 2 of 9 | 4 weeks
...
- 5 workflow lib modules (§6) + the shared `progress-summary` helper (§6.6). (The wins
...
# reduced-motion guard present in the animation foundation (RM-01)
