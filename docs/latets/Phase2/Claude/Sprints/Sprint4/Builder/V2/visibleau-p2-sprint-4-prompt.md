...
# Version: 1.1 | Built against: LLD v8.66 (REVIEWED-r2) | Sprint: 4 of 9 | 4 weeks
...
source_type_gaps (citation_source_intelligence, S5) — **do NOT import or query those tables in
S4** (they don't exist yet → TypeScript/SQL would fail). Instead the framework exposes a typed
...
- **Reads — split by build-order (§6.1):** wire NOW (tables exist this sprint): visibility_trends,
  ...
  content_structure_audits (S6). Applies narrative-generator RULES 1–11; each section renders only
