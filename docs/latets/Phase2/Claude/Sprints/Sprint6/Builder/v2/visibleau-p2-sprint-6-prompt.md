...
# Version: 1.1 | Built against: LLD v8.66 (REVIEWED-r2) | Sprint: 6 of 9 | 4 weeks
...
# APPEND-ONLY crawler_visit_logs (no ON CONFLICT — INSERT a new row per visit)
grep -ic "on conflict\|onConflict" inngest/functions/crawler-log-ingest.ts            # → 0
