...
prompt (v1.5)**, the **CDN enhancement delta (v1.2)** that layers on top of it, and a **driver
...
2. **`visibleau-p2-sprint6-cdn-shield-enhancement.md`** — CDN delta, **v1.2** (layers on the core).
...
decision.
**CDN enhancement (v1.2):** 1 pure lib file `lib/crawler/cdn-shield-detector.ts` (+ test); 1 edit to
