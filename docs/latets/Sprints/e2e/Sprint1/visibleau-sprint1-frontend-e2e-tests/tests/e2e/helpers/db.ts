...
// C13 FIX: helpers/db.ts is at tests/e2e/helpers/db.ts
// 3 levels up (../../../) reaches the project root — not 4 levels (../../../../)
// 4 levels would resolve to the parent of the project root (outside the repo)
import * as schema from '../../../db/schema';
import type { Organization, User, Brand } from '../../../db/schema';
