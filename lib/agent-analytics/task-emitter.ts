...
import type { FiveXxResult, RobotsViolation, VerificationRate } from "./metrics";
...
export async function emit5xxTasks(ctx: TaskEmitContext, results: FiveXxResult[]): Promise<number> {
  let emitted = 0;
