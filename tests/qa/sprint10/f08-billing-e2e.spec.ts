...
test.describe("F08: Billing Page (Sprint 10)", () => {
  test("F08-E2E-01: Billing page loads at /settings/billing after sign-in", async ({ page }) => {
    await signIn(page);
  ...
  test("F08-E2E-02: Billing page shows tier or plan info", async ({ page }) => {
    await signIn(page);
    await page.goto("/settings/billing");
    await page.waitForLoadState("networkidle");
  ...
  test("F08-E2E-03: Billing page shows current plan card", async ({ page }) => {
    await signIn(page);
    await page.goto("/settings/billing");
    await page.waitForLoadState("networkidle");
  ...
  test("F08-E2E-04: Unauthenticated /settings/billing redirects to sign-in", async ({ page }) => {
